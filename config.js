module.exports = {
    options: {
        ...
        intro: `<p class="section">Welcome to this site, which lists the programmes, tickets and other matchday Arsenal memorabilia in my collection and also highlights some of the gaps. If you can help with any item that I'm missing please email me at paul.matz@hotmail.com or give me a call on 07850 920899.  I also collect just about anything and everything related to Arsenal Football Club in addition to the matchday items shown here.</p> <p class="section">I am part of the team behind '<a href="http://thearsenalcollection.org.uk/">The Arsenal Collection</a>' website, which  is a digital collection of Arsenal memorabilia. Already on this site are images from hundreds of programmes from my collection, showing every page of each programme, not just the front cover. One of my oldest programmes can be found <a href="http://thearsenalcollection.org.uk/sheffield-united-v-arsenal-football-league-division-one-wednesday-december-28th-1904/">here</a> and a pre-war handbook is <a href="http://thearsenalcollection.org.uk/1994-95-arsenal-handbook-2/">here</a>. Enjoy!.</p>`,
        data_points: {
            season: 'Season',
            date: 'Date',
